...
function Get-PublicIP {
    ...
    Write-Host "$ip was saved to clipboard"
}
Set-Alias -Name getip -Value Get-PublicIP
...
function Get-Files {
    ...
    eza.exe --group-directories-first --git --icons always $Path
}
...
function ll {
    ...
    eza.exe --group-directories-first -l --git --icons always $Path
}
...
function la {
    ...
    eza.exe -lab --group-directories-first -l --git --icons always $Path
}
...
function Get-Tree {
    ...
    lsd.exe --tree -a --depth=$Depth $Path
}
